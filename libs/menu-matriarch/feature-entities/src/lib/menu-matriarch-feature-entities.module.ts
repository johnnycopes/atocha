...
import { FilterableListComponent, TabComponent, TabsetComponent } from '@atocha/menu-matriarch/ui';
...
@NgModule({
  ...
  imports: [CommonModule, FilterableListComponent, TabsetComponent, TabComponent],
})
