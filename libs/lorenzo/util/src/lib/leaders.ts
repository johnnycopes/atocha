...
export const LEADERS: Leader[] = [
  ...
  },
  {
    ...
    ability: 'When you place one of your Family Members here, perform a Harvest action OR a Production action at the value of the placed Family Member. You can increase this action value',
    type: 'action',
  },
  {
    name: "Carlo VIII",
  ...
  },
  {
    ...
    ability: "You may waive the Military Points requirement when you take Territory Cards",
    type: 'permanent',
  },
  {
  ...
  },
  {
    ...
    ability: "When you place one of your Family Members here, gain 3 wood, 3 stone, and 3 Victory Points",
    type: 'action',
  },
  {
  ...
  },
  {
    ...
    ability: "One of your colored Family Members has value 6, regardless of its related die",
    type: 'once per round',
  },
  {
  ...
  },
  {
    ...
    ability: "You don't have to spend 3 coins when you place your Family Members in an already occupied tower",
    type: 'permanent',
  },
  {
  ...
  },
  {
    ...
    ability: "When you place one of your Family Members here, gain 2 Military Points and 3 Faith Points",
    type: 'action',
  },
  {
    name: "Jacopo Salivate",
    requirement: '3 Building Cards and 8 Military Points',
    ability: "Whenever you receive 1 or more Council Privileges, take 1 additional Council Privelege of any type",
    type: 'permanent',
  },
  {
  ...
  },
  {
    ...
    ability: "Perform a Production action at value 0. You may increase this value",
    type: 'once per round',
  },
  {
    name: "Lorenzo de' Medici",
    requirement: '35 Victory Points',
    ability: "Copy the ability of another Leader Card already played by another player. Once you've decided which ability to copy, it cannot be changed",
    type: 'immediate',
  },
  {
    name: "Lucia da Narni",
    requirement: '6 Development Cards, max 1 Territory Card, and max 2 Special Tokens',
  ...
  },
  {
    ...
    ability: "Your colored Family Members have a bonus of +2 on their value. You may increase this value",
    type: 'permanent',
  },
  {
  ...
  },
  {
    ...
    requirement: '2 Territory Cards, 2 Character Cards, 2 Building Cards, and 2 Venture Cards',
    ability: "Your colored Family Members have a value of 5, regardless of their related dice. You may increase this value",
    type: 'permanent',
  },
  {
  ...
  {
    name: "Martin Lutero",
    requirement: '7 Military Points, 1 Territory Card, 1 Character Card, 1 Building Card, and 1 Venture Card',
  ...
  },
  {
    ...
    ability: "When you place one of your Family Members here, receive 3 Special Tokens and gain 5 Victory Points",
    type: 'action',
  },
  {
  ...
  },
  {
    ...
    ability: "Whenever you gain Victory Points, gain 1 additional Victory Point",
    type: 'permanent',
  },
  {
    name: "Palla Strozzi",
  ...
  },
  {
    ...
    ability: "When you take Development Cards, you get a discount of 3 coins for the cards, but not for the occupied tower cost",
    type: 'permanent',
  },
  {
    name: "Piero della Francesca",
    requirement: '4 Special Tokens and 10 Victory Points',
    ability: "When you place one of your Family Members here, receive 3 Special Tokens",
    type: 'action',
  },
  {
    name: "Pietro Bembo",
    requirement: '3 Character Cards and 3 Faith Points',
    ability: "When you place one of your Family Members here, receive 3 coins and 3 servants",
    type: 'action',
  },
  {
    name: "Raffaello Sanzio",
    requirement: '3 Character Cards, 6 wood, and 4 servants',
    ability: "You may lose 1 Victory Point to gain 3 coins OR discard 1 coin to gain 3 Victory Points",
    type: 'once per round',
  },
  {
  ...
  },
  {
    ...
    ability: "Each time you receive wood, stone, coin, or servants as an immediate effect from Development Cards (not from an action space), you receive the resources twice",
    type: 'permanent',
  },
  {
    name: "Sigismondo Malatesta",
    requirement: '7 Military Points and 3 Faith Points',
    ability: "Your uncolored Family Member has a bonus of +3 on its value. You may increase this value",
    type: 'permanent',
  },
  {
    name: "Sisto IV",
    requirement: '6 stone, 6 wood, 6 servants, and 6 coins',
    ability: "You gain 5 additional Victory Points when you support the Church in a Vatican Report",
    type: 'permanent',
  },
  {
