export const ADVERSARIES = [
  ...
  },
  {
    ...
    identifier: 'TheHabsburgMonarchy',
    expansion: 'Jagged Earth',
    levels: [
      { id: 'hm-0', name: 'Level 0', level: 0, difficulty: 2 },
      { id: 'hm-1', name: 'Level 1', level: 1, difficulty: 3 },
      { id: 'hm-2', name: 'Level 2', level: 2, difficulty: 5 },
      { id: 'hm-3', name: 'Level 3', level: 3, difficulty: 6 },
      { id: 'hm-4', name: 'Level 4', level: 4, difficulty: 8 },
      { id: 'hm-5', name: 'Level 5', level: 5, difficulty: 9 },
      { id: 'hm-6', name: 'Level 6', level: 6, difficulty: 10 },
    ],
  },
  {
    ...
    levels: [
      { id: 'hme-0', name: 'Level 0', level: 0, difficulty: 1 },
      { id: 'hme-1', name: 'Level 1', level: 1, difficulty: 3 },
      { id: 'hme-2', name: 'Level 2', level: 2, difficulty: 4 },
      { id: 'hme-3', name: 'Level 3', level: 3, difficulty: 5 },
      { id: 'hme-4', name: 'Level 4', level: 4, difficulty: 7 },
      { id: 'hme-5', name: 'Level 5', level: 5, difficulty: 9 },
      { id: 'hme-6', name: 'Level 6', level: 6, difficulty: 10 },
    ],
  },
  {
    name: 'Russia',
  ...
  },
  {
    ...
    levels: [
      { id: 'sc-0', name: 'Level 0', level: 0, difficulty: 1 },
      { id: 'sc-1', name: 'Level 1', level: 1, difficulty: 3 },
      { id: 'sc-2', name: 'Level 2', level: 2, difficulty: 4 },
      { id: 'sc-3', name: 'Level 3', level: 3, difficulty: 6 },
      { id: 'sc-4', name: 'Level 4', level: 4, difficulty: 7 },
      { id: 'sc-5', name: 'Level 5', level: 5, difficulty: 8 },
      { id: 'sc-6', name: 'Level 6', level: 6, difficulty: 10 },
    ],
  },
  {
    name: 'Sweden',
