describe('InternalCountedSelectionTreeComponent', () => {
  ...
  beforeEach(() => {
    ...
    stories = {
      noneSelected:
        '/iframe.html?id=internal-counted-selection-tree--none-selected',
      someSelected:
        '/iframe.html?id=internal-counted-selection-tree--some-selected',
      allSelected:
        '/iframe.html?id=internal-counted-selection-tree--all-selected',
    };
  });
