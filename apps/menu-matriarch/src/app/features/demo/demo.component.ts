  ...
  public sections: { title: string; description: string }[] = [
    {
      title: 'Section A',
      description:
        'This is section A. Content goes in this section. Additonal sentence here.',
    },
    {
      title: 'Section B',
      description:
        'This is section B. Content goes in this section. Additonal sentence here.',
    },
    {
      title: 'Section C',
      description:
        'This is section C. Content goes in this section. Additonal sentence here.',
    },
  ];
