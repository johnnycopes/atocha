...
- `npx storybook@latest automigrate --config-dir libs/core/ui/.storybook`

- `npx storybook@latest automigrate --config-dir libs/sandbox/ui/.storybook`

- `npx storybook@latest automigrate --config-dir libs/tree/ui/.storybook`
