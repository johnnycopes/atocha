...
- `npx storybook automigrate --config-dir .storybook`

- `npx storybook automigrate --config-dir libs/core/ui/.storybook`

- `npx storybook automigrate --config-dir libs/sandbox/ui/.storybook`

- `npx storybook automigrate --config-dir libs/tree/ui/.storybook`
